...
char Versions[] = "ES 1";						//当前版本
char Versions1[] = "ES 1.1.1.4";				//当前版本
...
void Store2EepromInit()
{
	...
	store.Data[3].FileColor        = c_huang;
	...
	save_setting.Data.EMC_SCR_PROTECT		 = 0;							//默认充电时不可用
