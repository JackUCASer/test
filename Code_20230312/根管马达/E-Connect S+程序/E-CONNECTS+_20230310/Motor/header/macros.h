...
#define KP_Speed 0x335F
#define KP_Speed_Gain 0x8011

#define KI_Speed 0x2951
#define KI_Speed_Gain 0x8016

#define KP_Position 0x347E
#define KP_Position_Gain 0x000B

//#define KP_Speed 0x42B8
//#define KP_Speed_Gain 0x800E

//#define KI_Speed 0x35A8
//#define KI_Speed_Gain 0x8015

//#define KP_Position 0x347E
//#define KP_Position_Gain 0x000B

#define KP_Speed2 0x42B8
#define KP_Speed_Gain2 0x800E

#define KI_Speed2 0x35A8
#define KI_Speed_Gain2 0x8015

#define KP_Position2 0x347E
#define KP_Position_Gain2 0x000B
...
#define KP_Speed1 0x3883
#define KP_Speed_Gain1 0x8010

#define KI_Speed1 0x2D73
#define KI_Speed_Gain1 0x8017

#define KP_Position1 0x347E
#define KP_Position_Gain1 0x000B
///**********CIK_motor 1 ****************/
...
////#define KI_Speed 0x35A8
////#define KI_Speed_Gain 0x4017

//#define KI_Speed 0x35A8
//#define KI_Speed_Gain 0x4017

////#define KP_Position 0x347E
////#define KP_Position_Gain 0x00B
//#define KP_Position 0x447E
//#define KP_Position_Gain 0x00A

#define TQ_DISP_GIRD 8

//Motor Parameters
#define m_p 	2						//pole pairs of the motor
#define m_Vin 	9						//(V)DC input voltage
...
/**************************************/
/************** LY_motor 2 ****************/
// #define KP_Current 0x02A5
//#define KI_Current 0x109A

//#define KP_Speed 0x03D2//0x08D2
//#define KP_Speed_Gain 0x800C

//#define KI_Speed 0x0E30
//#define KI_Speed_Gain 0x8014

//#define KP_Position 0x04F3
//#define KP_Position_Gain 0x000E

//#define TQ_DISP_GIRD 16

////Motor Parameters
//#define m_p 	1						//pole pairs of the motor
//#define m_Vin 7						//(V)DC input voltage
//#define m_Rs	1.2				//(ohm)winding resistor(phase-phase)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
...
#define mp6570_enable()			HAL_GPIO_WritePin(MP6570_EN_GPIO_Port,MP6570_EN_Pin,GPIO_PIN_SET);//	GPIOB->BSRR = 0x00000002  // GPIO_WriteOutBits(EN_OUT_GPIO_ID, EN_OUT_AFIO_PIN, SET) //set EN_6570
#define mp6570_disable()		HAL_GPIO_WritePin(MP6570_EN_GPIO_Port,MP6570_EN_Pin,GPIO_PIN_RESET);	//GPIOB->BSRR = 0x00020000

//#define NSS_SET				HAL_GPIO_WritePin(GPIOA,NSS_Pin,GPIO_PIN_SET)
//#define NSS_RESET			HAL_GPIO_WritePin(GPIOA,NSS_Pin,GPIO_PIN_RESET)

#define PEND_SET			__NOP  
#define PEND_RESET		__NOP 

#define LOOPTIMERINT_ENABLE				__NOP//NVIC_EnableIRQ(SCTM1_IRQn)
#define LOOPTIMER_ENABLE      			HAL_TIM_Base_Start_IT(&htim4);  
#define	LOOPTIMER_DISABLE				HAL_TIM_Base_Stop_IT(&htim4);
