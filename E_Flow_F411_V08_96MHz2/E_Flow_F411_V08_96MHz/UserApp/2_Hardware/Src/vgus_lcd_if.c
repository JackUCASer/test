...
//	VGUS_LCD("PAGE_MODE_ASP= %d, and PAGE_MODE_BTM= %d, and PAGE_MODE_DOSE= %d\r\n",
//		vgus_page_objs[PAGE_Mode].obj_value[0], vgus_page_objs[PAGE_Mode].obj_value[1], vgus_page_objs[PAGE_Mode].obj_value[2]);
	buf2[2] = PAGE_Setting;
...
//	VGUS_LCD("PAGE_SETT_RMD= %d, and PAGE_SETT_TRN= %d, and PAGE_SETT_LIT= %d, and PAGE_SETT_VOL= %d\r\n",
//		vgus_page_objs[PAGE_Setting].obj_value[0], vgus_page_objs[PAGE_Setting].obj_value[1], 
//		vgus_page_objs[PAGE_Setting].obj_value[2], vgus_page_objs[PAGE_Setting].obj_value[3]);
	buf2[2] = PAGE_Aging;
...
//	VGUS_LCD("PAGE_AGE_BTM= %d\r\n",vgus_page_objs[PAGE_Aging].obj_value[0]);
	Set_VGUS_Display_String(0x0004, 9, (uint8_t*)EB_VERSION);
}
