...
{
	CALIB_READY = 0,
	CALIB_FWD_1st,		//	第一次：正转
	CALIB_FWD_IDLE,		//	最顶端停留，然后以低速启动
	CALIB_FWD_IDLE2, 	//	变速，由低速变为高速
	CALIB_REV_2nd,		//	第二次：反转
	CALIB_REV_IDLE,		//	最低端停留，然后以高速启动
	CALIB_FWD_3rd,		//	第三次：正转
	CALIB_FINISH		//	校正完成
...
//	电机校正界面
#define PAGE_CALIB_OILPS_ID		0x01
#define PAGE_CALIB_FINISH_ID	0x02

//	脚踏校正界面
#define PAGE_CALIB_PEDAL_ID			0x01 
#define PAGE_PEDAL_CALIB_FINISH_ID	0x02
#define PAGE_PEDAL_CALIB_CANCEL_ID	0x03
