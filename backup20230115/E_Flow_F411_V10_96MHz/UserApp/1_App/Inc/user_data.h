...
/*	------------------------------------------全局变量及常量-------------------------------------------------	*/
#define MINUTES		5	//	单位：分钟
#define MAX_IDLE_TIME_CNT	400*MINUTES
extern const uint8_t EB_VERSION[];
extern SYS_PARA_T sys_para_t;						/*	系统参数	*/
extern uint32_t IDLE_TIME_CNT;						//	用于系统空闲计数器，如果连续5分钟无操作，系统自动关机
extern CHARGE_STATE_E CHARGE_STATE;					/*	设备充电状态	*/
...
bool Start_SysUpdate(void);							/*	开始系统更新	*/
bool Stop_SysUpdate(void);							/*	停止系统更新	*/
...
/*	----------------------------------------其他接口---------------------------------------------------	*/										
void PWR_On_Off_Detect2(void);										/*	开关机及充电检测	*/
