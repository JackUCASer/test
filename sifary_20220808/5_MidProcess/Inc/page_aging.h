...
#define PAGE_AGING_COMM_ID		0x0905			//	通信测试  ID
#define PAGE_AGING_CYCLE_ID		0x0907			//	老化圈数  ID
#define PAGE_AGING_kPa_ID		0x0909			//	液压具体值
#define PAGE_AGING_mV_ID		0x090B			//	脚踏具体电压值
